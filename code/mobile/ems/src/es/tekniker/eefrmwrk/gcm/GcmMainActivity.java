...
public class GcmMainActivity extends Activity {
    ...
    public static final String PROPERTY_NOTIFICATION_NUMBER= "notification_number";
    public static final String PROPERTY_NOTIFICATION_LIST= "notification_list";
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        data.putString("my_message", "EMS Mobile dummy");
                        data.putString("my_action", "com.google.android.gcm.demo.app.ECHO_NOW");
                        String id = Integer.toString(msgId.incrementAndGet());
                        gcm.send(Defines.GCM_SENDER_ID+ "@gcm.googleapis.com", id, data);
                        msg = "Sent message";
                    } catch (IOException ex) {
                        msg = "Error :" + ex.getMessage();
                    }
